...
<div class="container">
<div class="mt-2"></div>
<h3 style="margin-left: auto; margin-right: auto; text-align: center;">Edit Transaksi Penjualan</h3><br>

<form method="POST" action="{{route('jual.update',$data->no_bukti)}}" style="margin-left: auto; margin-right: auto; width: 50%;">
   @csrf
   @method("PUT")
  ...
  <div class="form-group">
    ...
    <select class="form-control" name="select_customer">
        ...
        <option value="{{$c->kode_cust}}" @if($c->kode_cust == $data->kode_cust) selected @endif>{{$c->nama_cust}}</option>
        @endforeach
    </select>
  </div><br>
  <div class="form-group">
